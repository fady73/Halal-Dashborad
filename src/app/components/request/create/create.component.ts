...
export class CreateComponent implements OnInit {
  ...
  save() {
  //  let x = this.comments.filter(obj => {
  ...
  //   obj !== foo_object});
    ...
    if(this.companyDetailsViewModel.CompanyType==1)
    {
      var removed = comments.splice(4,2);
      comments.pop();
    }
    if(this.companyDetailsViewModel.CompanyType==0)
    {
      var removed = comments.splice(5,1);
    }
